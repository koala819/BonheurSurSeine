...
export const metadata: Metadata = {
  ...
  description:
    'Gyroroue / Roue électrique : conseils et tests produits, évaluations détaillées, avis, comparatifs, photos et vidéos YouTube pour faire son choix avec le BonheurScore.',
  alternates: {
