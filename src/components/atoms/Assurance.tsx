      ...
      <Accordion>
        ...
        >
          <div className="blueBlock mb-8">
            ...
            <span>
              Si quelqu&apos;un te dit autre chose, soit il ment, soit il est incompétent.
            </span>
          </div>
          <h3>À retenir :</h3>
          <ul className="list-disc pl-4 space-y-4 mb-4">
            <li>La roue est un <strong>véhicule terrestre à moteur</strong> et,
            ...
            <li>La vignette (papillon vert) doit être affichée sur le véhicule (
				...
				{' '}et{' '}
				<Link href="https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000006812176"
				target="_blank" className="link-style">R211-21-5</Link>
				), en plus d’avoir sur soi l&apos;attestation d&apos;assurance (carte verte -{' '} 
				<Link href="https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000048547657"
				target="_blank" className="link-style">R211-21-14</Link>).
				</li>
            <li>Attention, les contrats d&apos;assurance habitation ne couvrent
				généralement pas les EDPM, catégorie à laquelle appartiennent les
				roues. Il faut un contrat d&apos;assurance dédié (comme pour une moto ou une voiture).
				</li>
            <li>En l&apos;absence d&apos;assurance, tu risques une amende (jusqu&apos;à 3750€ -{' '}
				<Link href="https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000025043014"
                target="_blank" className="link-style">L324-2</Link>
				), la confiscation du véhicule, et surtout des dizaines de
				milliers d&apos;euros à charge en cas de collision/blessure d&apos;un autre usager.
				</li>
          </ul>
