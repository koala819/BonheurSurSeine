    ...
    <section className="mx-auto max-w-2xl px-4 lg:max-w-7xl lg:px-8 mt-8">
      <div className="flex flex-wrap justify-between md:mb-16">
        <div className="flex w-full flex-col justify-center lg:mb-0 lg:w-1/3 lg:pb-24 lg:pt-48">
          ...
          <div className="max-w-md leading-relaxed text-gray-500 dark:text-gray-300 xl:text-lg">
        ...
        <div className="flex w-full relative md:mb-16 lg:w-2/3">
          {/* Image de Derrière */}
          <div className="absolute inset-0 overflow-hidden rounded-lg bg-gray-100 shadow-lg">
            <Image
              src={photo_back.url || ''}
              alt={photo_back.alt || ''}
