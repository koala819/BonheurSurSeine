...
const Maintenance = () => {
  return (
    ...
    >
      ...
      <div className="mb-6 mx-6 bg-blue-100 dark:bg-cyan-800 p-4 rounded-xl shadow-md">
        <p className="">
          ✳️{' '}
          <b>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 px-6">
        ...
        <div className="space-y-2 mt-4">
          ...
          <ul className="list-none space-y-1 p-0 mb-6">
            ...
            <li className="flex items-start mb-0">
              ...
              <div>
                <p>
                  <b>Tourner</b> → mettre son poids sur un côté et tourner les
                  épaules (comme en ski).
                </p>
              </div>
            </li>
          </ul>
        ...
        {/* ------------------ Explications ------------------ */}
        <div>
          <h3 className="font-bold mb-1">🧠 Pourquoi ça tient debout&nbsp;?</h3>
          <ul className="list-disc ml-6 mt-2 space-y-1">
            ...
            <li>
              Le pilote contrôle la direction (gauche/droite) comme en vélo ou
              en ski.
            </li>
          </ul>
        </div>
